...
"[project]/node_modules/next/dist/compiled/react-dom-experimental/cjs/react-dom-server.node.development.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function createRequest(children, resumableState, renderState, rootFormatContext, progressiveChunkSize, onError, onAllReady, onShellReady, onShellError, onFatalError, onPostpone, formState) {
        ...
        children = createRenderTask(resumableState, null, children, -1, null, renderState, null, resumableState.abortableTasks, null, rootFormatContext, null, emptyTreeContext, null, !1, emptyContextObject, null);
    ...
    function createRenderTask(request, thenableState, node, childIndex, blockedBoundary, blockedSegment, hoistableState, abortSet, keyPath, formatContext, context, treeContext, componentStack, isFallback, legacyContext, debugTask) {
                ...
                case REACT_SUSPENSE_TYPE:
                    a: if (null !== task.replay) {
                        ...
                        if (null !== request.trackedPostpones) {
                            ...
                            var suspendedPrimaryTask = createRenderTask(request, null, content, -1, newBoundary, contentRootSegment, newBoundary.contentState, task.abortSet, keyPath, task.formatContext, task.context, task.treeContext, task.componentStack, task.isFallback, emptyContextObject, task.debugTask);
                ...
                if (4 === node.length) {
                    ...
                    a: {
                        ...
                        try {
                            ...
                            resumedBoundary.status = CLIENT_RENDERED, childNodes = getThrownInfo(task.componentStack), "object" === typeof error && null !== error && error.$$typeof === REACT_POSTPONE_TYPE ? (logPostpone(request, error.message, childNodes, task.debugTask), replay = "POSTPONE") : replay = logRecoverableError(request, error, childNodes, task.debugTask), encodeErrorForBoundary(resumedBoundary, replay, error, childNodes, !1), task.replay.pendingTasks--, request.clientRenderedBoundaries.push(resumedBoundary);
                        } finally{
    ...
    function spawnNewSuspendedRenderTask(request, task, thenableState) {
        ...
        segment.lastPushedText = !1;
        return createRenderTask(request, thenableState, task.node, task.childIndex, task.blockedBoundary, newSegment, task.hoistableState, task.abortSet, task.keyPath, task.formatContext, task.context, task.treeContext, task.componentStack, task.isFallback, emptyContextObject, task.debugTask);
    }
    ...
    function getPostponedState(request) {
        ...
        if (null !== request.completedRootSegment && request.completedRootSegment.status === POSTPONED) {
        ...
        } else resumableState = request.resumableState, resumableState.bootstrapScriptContent = void 0, resumableState.bootstrapScripts = void 0, resumableState.bootstrapModules = void 0;
        return {
...
//# sourceMappingURL=a11f7_compiled_react-dom-experimental_cjs_react-dom-server_node_development_aafe6e.js.map