...
export const tools = {
    ...
    getTerminalInfo: {
        description: "Retrieve information about terminals based on search criteria. NOT FOR SELLING OR BUYING JUST INFORMATION",
        parameters: z.object({
      ...
      getCommoditiesByTerminal: {
        description: "DOES NOT PROVIDE PRICING INFORMATION use calculateBestTradeRoute!. Retrieve a list of commodities available at a specific terminal, including whether they are buyable, sellable, and their wiki links.",
        parameters: z.object({
